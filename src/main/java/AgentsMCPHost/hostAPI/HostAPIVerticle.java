...
public class HostAPIVerticle extends AbstractVerticle {
  ...
  private void setupRoutes() {
    ...
    HealthVerticle.setRouter(mainRouter);
    StatusVerticle.setRouter(mainRouter);
    ConversationVerticle.setRouter(mainRouter);
    
    // Mount MCP status endpoints from McpHostManagerVerticle
    AgentsMCPHost.mcp.host.McpHostManagerVerticle.setRouter(mainRouter);
