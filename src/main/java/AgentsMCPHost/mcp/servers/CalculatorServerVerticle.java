 ...
 */
public class CalculatorServerVerticle extends AbstractVerticle {
    
    private static final int PORT = 8081;
    private static final String MCP_PROTOCOL_VERSION = "2024-11-05";
    private static CalculatorServerVerticle instance;
    ...
    public static void setRouter(Router router) {
        ...
        router.post("/").handler(CalculatorServerVerticle::handleMcpRequest);
        router.get("/").handler(CalculatorServerVerticle::handleSseStream);
    }
    ...
    private static void handleMcpRequest(RoutingContext ctx) {
        try {
            ...
            CalculatorServerVerticle verticle = instance;
            if (verticle == null) {
