package AgentsMCPHost.mcp.servers.examples.filesystem;
 ...
 */
public class FileSystemServer extends AbstractVerticle {
    ...
    public static void setRouter(Router router) {
        ...
        router.post("/").handler(FileSystemServer::handleMcpRequest);
        router.get("/").handler(FileSystemServer::handleSseStream);
        
        // Resources endpoint
        router.get("/resources/:id").handler(FileSystemServer::handleResourceRequest);
    }
    ...
    private static void handleMcpRequest(RoutingContext ctx) {
        try {
            ...
            FileSystemServer verticle = instance;
            if (verticle == null) {
