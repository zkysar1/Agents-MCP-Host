package AgentsMCPHost.mcp.servers.examples.database;
...
public class DatabaseServer extends AbstractVerticle {
    ...
    public static void setRouter(Router router) {
        ...
        router.post("/").handler(DatabaseServer::handleMcpRequest);
        router.get("/").handler(DatabaseServer::handleSseStream);
    }
    ...
    private static void handleMcpRequest(RoutingContext ctx) {
        try {
            ...
            DatabaseServer verticle = instance;
            if (verticle == null) {
