 ...
 */
public class WeatherServerVerticle extends AbstractVerticle {
    
    private static WeatherServerVerticle instance;
    ...
    public static void setRouter(Router router) {
        ...
        router.post("/").handler(WeatherServerVerticle::handleMcpRequest);
        router.get("/").handler(WeatherServerVerticle::handleSseStream);
    }
    ...
    private static void handleMcpRequest(RoutingContext ctx) {
        try {
            ...
            WeatherServerVerticle verticle = instance;
            if (verticle == null) {
